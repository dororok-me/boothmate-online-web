...
(function () {
  ...
  var DICT = {
    ...
    '자막은 통역 중 30초마다·정지 시 자동 저장(최대 50개). 내보내기는 현재 화면 자막을 txt로, 전체 삭제는 저장된 자막을 모두 지웁니다. 각 항목 아래에 원문·번역 내용이 바로 표시되며, 제목 줄을 누르면 접었다 펼 수 있습니다.': 'Subtitles are auto-saved every 30s while interpreting and on stop (up to 50). Export saves the current on-screen subtitles as txt; Delete all removes every saved subtitle. Each item shows its source and translation right below; click the title row to collapse or expand.',
